#broken code homework

#import python random model
import random
...
"cat", "hulk", "freeze", "storm", "nano", "flying", "destroyer", "py crusher ", 
"diva", "amazon", "firestarter", ]
...
def super_shuffles(list1, list2): #defining function -- this line works
    ...
    for person in students: # start for loop for students list
        for power in supers: #start start for loop for supers list
            ...
            print secret_identity # what is being printed? 
